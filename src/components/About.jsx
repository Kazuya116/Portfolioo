  ...
  return (
    <section className="py-16 bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          I'm Aman Pratap Singh, a Fullstack Web Developer. Passionate about
          building scalable applications, problem-solving with 200 above question solved on leetcode.
        </motion.p>
